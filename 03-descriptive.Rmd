...
```{r echo=FALSE, fig.cap='Distribution of admission rates for thw 2,019 institutions of higher education. The mean admission rate is displayed as a red, dashed line.', warning=FALSE}
...
```{r echo=FALSE, fig.cap='Distribution of admission rates for thw 2,019 institutions of higher education. The median admission rate is displayed as a blue, solid line.', warning=FALSE}
gf_histogram(~ adm_rate, data = colleges, bins = 30) %>%
  gf_labs(x = "Admission rate", y = "Frequency") %>%
  gf_vline(color = 'blue', xintercept = 0.708, size = 1) %>%
  gf_text(x = 0.4, y = 5, label = "50%", color = "blue", size = 5) %>%
  gf_text(x = 0.9, y = 5, label = "50%", color = "blue", size = 5)
```
...
```{r echo=FALSE, fig.cap='Distribution of the admission rates for 2,019 institutions of higher education. The mean admission rate is displayed as a red, dashed line. The median admission rate is displayed as a blue, solid line.', warning=FALSE}
gf_histogram(~ adm_rate, data = colleges, bins = 30) %>%
  gf_labs(x = "Admission rate", y = "Frequency") %>%
  gf_vline(color = 'red', xintercept = 0.683, size = 1, linetype = "dashed") %>%
  gf_vline(color = 'blue', xintercept = 0.708, size = 1)
...
```{r echo=FALSE, fig.cap='Distribution of the admission rates for 2,019 institutions of higher education. The solid, red lines are placed at the 10th and 90th percentiles, respectively.', warning=FALSE}
gf_histogram(~ adm_rate, data = colleges, bins = 30) %>%
  gf_labs(x = "Admission rate", y = "Frequency") %>%
...
```{r echo=FALSE, fig.cap='Distribution of the admission rates for 2,019 institutions of higher education. The solid, red lines are placed at the 25th and 75th percentiles, respectively.', warning=FALSE}
gf_histogram(~ adm_rate, data = colleges, bins = 30) %>%
  gf_labs(x = "Admission rate", y = "Frequency") %>%
...
```{r  echo=FALSE, fig.cap='Distribution of the admission rates for 2,019 institutions of higher education. The solid, red lines are placed at the 25th and 75th percentiles, respectively. The dashed, blue lines are placed at the minimum and maximum values, respectively.', warning=FALSE}
