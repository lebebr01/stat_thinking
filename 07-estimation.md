...
```
##   response        5%       50%       95%
## 1    slope 0.3950332 0.4680123 0.5402949
```
...
```
##   response        5%       50%       95%
## 1    slope -11.01762 -9.253884 -7.511695
```
...
## [90m2[39m I(gestational_days - mean(gestational_days))    0.480
## [90m3[39m maternal_smokerTRUE                            -[31m9[39m[31m.[39m[31m60[39m
```
...
## [90m2[39m I(gestational_days - mean(gestational_days))                        0.339
## [90m3[39m maternal_smokerTRUE                                                -[31m8[39m[31m.[39m[31m42[39m 
## [90m4[39m I(gestational_days - mean(gestational_days)):maternal_smokerTRUE    0.288
```
