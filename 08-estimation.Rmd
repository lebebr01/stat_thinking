...
```{r resample-baby-once, eval = FALSE}
...
```{r resample-10k-density, eval = FALSE}
...
```{r quantile-resample, eval = FALSE}
baby_coef %>%
...
```{r descriptive-smoker, eval = FALSE}
baby %>%
