...
To provide a bit more context to the data, the station locations are shown below using the function `count(us_weather, location)` and shown in Table \@ref(tab:locations).
